...
class DetailNoteEntryRecyclerViewAdapter(var dataset: MutableList<Line>) : RecyclerView.Adapter<DetailNoteEntryRecyclerViewAdapter.ItemViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        holder.lineText.doAfterTextChanged { line.text = it.toString() }
    }
